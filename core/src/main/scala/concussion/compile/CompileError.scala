...
final case class ExpectedParameters(opcode: String, message: String) extends CompileError
final case class InvalidOpcode(opcode: String) extends CompileError
