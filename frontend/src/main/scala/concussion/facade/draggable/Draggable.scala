...
object Draggable {
  ...
  trait Props extends js.Object {
    ...
    var onMouseDown: js.UndefOr[rawjs.RawOnMouseDown]
    var onStart: js.UndefOr[rawjs.RawDraggableEventHandler]
    var onDrag: js.UndefOr[rawjs.RawDraggableEventHandler]
    var onStop: js.UndefOr[rawjs.RawDraggableEventHandler]
